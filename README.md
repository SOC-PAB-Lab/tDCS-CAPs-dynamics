...
Contains intermediate data outputs generated by the Python pipeline.

| Path | Description |
|------|-------------|
| `data/coactivation_patterns_run-ON/CAP_TS_run-ON_zscored.npy` | Concatenated z-scored time series matrix — input to k-means clustering. |
